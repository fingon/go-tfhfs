 ...
 * Last modified: Thu Feb 22 10:06:46 2018 mstenber
 * Edit time:     257 min
 *
 */
...
func (self *treeBackend) Flush() {
	...
	// Write superblock
	mlog.Printf2("storage/tree/tree", " writing superblock")
	self.superIndex++
	...
	if self.Pending != nil {
		for _, op := range self.Pending {
			mlog.Printf2("storage/tree/tree", " handling %v", op)
			if op.Free {
